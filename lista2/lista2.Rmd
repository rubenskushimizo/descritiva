...
dados = read.csv("C:/Users/Dell/Documents/ESTAT 2021 1º SEMESTRE/Estatística descritiva/listii.csv", sep = ";", h=T, dec=",")

'''
A inconstência encontrada é que a data de coleta é muito anterior a data de nasimento 
dos indivíduos.
'''
...
#Altura
hist(dados$Altura, breaks = 8, xlab = "Altura", ylab = "Frequência", main = "Histograma para a variável Altura")


#Peso
hist(dados$Peso, breaks = 8, xlab = "Peso", ylab = "Frequência", main = "Histograma para a variável Peso")

#Coltot
hist(dados$Coltot, breaks = 8, xlab = "Coltot", ylab = "Frequência", main = "Histograma para a variável Coltot")

#HDL
hist(dados$HDL, breaks = 8, xlab = "HDL", ylab = "Frequência", main = "Histograma para a variável HDL")

#HA
hist(dados$HA, breaks = 8, xlab = "HA", ylab = "Frequência", main = "Histograma para a variável HA")

#LDL
hist(dados$LDL, breaks = 8, xlab = "LDL", ylab = "Frequência", main = "Histograma para a variável LDL")

#Lesões
hist(dados$Lesoes, breaks = 8, xlab = "Lesões", ylab = "Frequência", main = "Histograma para a variável Lesões")
...
#Altura
boxplot(dados$Altura, main = "Boxplot para a variável Altura")

#Peso
boxplot(dados$Peso, main = "Boxplot para a variável Peso")

#Coltot
boxplot(dados$Coltot, main = "Boxplot para a variável Coltot")

#HDL
boxplot(dados$HDL, main = "Boxplot para a variável HDL")

#HA
boxplot(dados$HA, main = "Boxplot para a variável HA")

#Lesões
boxplot(dados$Lesoes, main = "Boxplot para a variável Lesões")
'''
...
Os gráficos de QQ plot normal indicam que a distribuição de todas as variáveis contínuas
seguem uma distribuição normal, pois os ponto estão seguindo uma sequência da linha qq normal. 
